...
in correspondence with the Magnus series. In particular, $\mathcal{F}\up{1}$ and $\mathcal{F}\up{2}$ are already given in the main text through \Eqref{eq:PDDMag1} and \Eqref{eq:PDDMag2}. 
