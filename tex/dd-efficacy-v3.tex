...
\includegraphics[height=0.9\linewidth]{pdd-noisypulse1}
\caption{$\eta =0.03$.}
\label{fig:pdd-noisy-pulse1}
\end{subfigure}
\\
\begin{subfigure}{0.8\linewidth}
\includegraphics[height=0.9\linewidth]{pdd-noisypulse2}
...
\end{equation}
with $U_g(\tau)= P_i$, where $ \mathcal{T}_\leftarrow$ is the time ordering operator. In \Eqref{eq:noisy-gate-formal}, we
