...
\end{equation}
to be sufficient for noise reduction. This inequality suggests that in order for DD to be useful, the duration of the control Hamiltonian should be at least be around half of the gate interval.  According to \Eqref{eq:PDD-rect1}, the sharper is the pulse, the better the noise removal will be in general.
...
\end{aligned}
\end{equation}
for integer $n\ge0$. Hence, we can calculate \Eqref{app:PDDnp-Gamma3} by 
\begin{equation}
\begin{aligned}
