...
satisfying the given parameters over the uniform Haar measure. Noisy PDD is simulated for each random instance to obtain the noise reduction ratio $\wt\Phi_\rSB/\phi_\rSB$, and maximal value is retained. The noise reduction condition $\wt\Phi_\rSB/\phi_\rSB\le 1$ determines a continuous region in the 3D parametric space of $(\phi_\rB,\phi_\rSB,\eta)$.
