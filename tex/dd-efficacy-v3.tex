...
\begin{figure}[htbp]
 ...
 \caption{The histogram for the ratios $\widetilde\phi_\rB/\widetilde\phi_\rB^{(\mathrm{ub})}$ and $\widetilde\phi_\rSB/\widetilde\phi_\rSB^{(\mathrm{ub})}$ over 5000 randomly generated $\Gamma$ and $\Omega$ ($2\times2$) matrices. The random $\Gamma$ and $\Omega$ are set to follow a normal distribution with magnitudes around $0.01$ . Our appropriate bounds in \Eqref{eq:comb-bound} is indicated with an arrow.}
